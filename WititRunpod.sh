...
echo "Downloading ZavyMix SD1.5 model"
cd /workspace/stable-diffusion-webui/models/Stable-diffusion
wget -O ZavyMix.safetensors https://civitai.com/api/download/models/126079

echo "Downloading ZavyChromaXL SDXL model"
cd /workspace/stable-diffusion-webui/models/Stable-diffusion
wget -O ZavyChromaXL.safetensors https://civitai.com/api/download/models/169740
